		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#syncc10gatewaycrud-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc10gatewaycrud-display": {
								"semanticObject": "syncc10gatewaycrud",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c10.gateway.crud",
									"url": sap.ui.require.toUrl("sync/c10/gateway/crud")
								}
							}
						}
					}
