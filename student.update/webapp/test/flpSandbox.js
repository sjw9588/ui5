		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "학생정보 수정하기",
									"targetURL": "#syncc10studentupdate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc10studentupdate-display": {
								"semanticObject": "syncc10studentupdate",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c10.student.update",
									"url": sap.ui.require.toUrl("sync/c10/student/update")
								}
							}
						}
					}
