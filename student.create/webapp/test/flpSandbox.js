		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "학생정보 생성하기",
									"targetURL": "#syncc10studentcreate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc10studentcreate-display": {
								"semanticObject": "syncc10studentcreate",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c10.student.create",
									"url": sap.ui.require.toUrl("sync/c10/student/create")
								}
							}
						}
					}
