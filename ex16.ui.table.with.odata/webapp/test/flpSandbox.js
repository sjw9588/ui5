		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#syncc10ex16uitablewithodata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc10ex16uitablewithodata-display": {
								"semanticObject": "syncc10ex16uitablewithodata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c10.ex16.ui.table.with.odata",
									"url": sap.ui.require.toUrl("sync/c10/ex16/ui/table/with/odata")
								}
							}
						}
					}
