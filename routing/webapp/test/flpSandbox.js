		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "화면 이동에 대한 연습",
									"targetURL": "#syncc10routing-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc10routing-display": {
								"semanticObject": "syncc10routing",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c10.routing",
									"url": sap.ui.require.toUrl("sync/c10/routing")
								}
							}
						}
					}
