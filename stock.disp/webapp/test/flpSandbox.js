		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#syncccmmstockdisp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncccmmstockdisp-display": {
								"semanticObject": "syncccmmstockdisp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.cc.mm.stock.disp",
									"url": sap.ui.require.toUrl("sync/cc/mm/stock/disp")
								}
							}
						}
					}
