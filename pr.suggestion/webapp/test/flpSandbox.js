		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[MM] 재주문 제안 프로그램",
									"targetURL": "#syncccmmprsuggestion-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncccmmprsuggestion-display": {
								"semanticObject": "syncccmmprsuggestion",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.cc.mm.pr.suggestion",
									"url": sap.ui.require.toUrl("sync/cc/mm/pr/suggestion")
								}
							}
						}
					}
