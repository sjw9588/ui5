		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OData Service를 사용해서 데이터 출력하기",
									"targetURL": "#syncc10odataservice-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc10odataservice-display": {
								"semanticObject": "syncc10odataservice",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c10.odata.service",
									"url": sap.ui.require.toUrl("sync/c10/odata/service")
								}
							}
						}
					}
