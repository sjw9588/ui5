		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "학생명단 제거",
									"targetURL": "#syncc10studentdelete-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncc10studentdelete-display": {
								"semanticObject": "syncc10studentdelete",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.c10.student.delete",
									"url": sap.ui.require.toUrl("sync/c10/student/delete")
								}
							}
						}
					}
